      ...
      await resend.emails.send({
        ...
        html: `
          <div style="background:#050508;color:#F0F0F8;font-family:Arial,sans-serif;padding:32px;max-width:560px;margin:0 auto;">
            ...
            <p style="margin:24px 0 0;font-size:12px;color:#6B6B7E;">Selected names will be announced on the event page. Questions? Reply to this email or message us on Instagram @sonicpulsefestival</p>
          </div>
        `,
      })
    } catch (emailErr) {
